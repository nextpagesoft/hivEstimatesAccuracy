...
if (miPresent) {
  ...
  refer to Table 1 and Figure 1 of the unadjusted data.
  </p>")
  ...
  if (cd4Present) {
    ...
    cat(sprintf("**Table %d. Median (IQR) CD4 cell count (cells/microL) by gender**<br />", outputIdx))
    ...
    outputIdx <- outputIdx + 1
    cat(sprintf("**Table %d. Median (IQR) CD4 cell count (cells/microL) by transmission**<br />", outputIdx))
  ...
  cat("Multiple Imputations adjustment has not been performed, threfore no outputs are presented in this section.")
}
```
