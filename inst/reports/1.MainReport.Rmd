...
cat(sprintf("<p>%s</p>", 
            switch(optReportingDelay, 
                   "FALSE" = "Original count of case.", 
                   "TRUE"  = "Correction of count of cases for reporting delay.")))

cat(sprintf("<p>%s</p>", 
            switch(optSmoothing, 
                   "FALSE" = "Original calendar time.", 
                   "TRUE"  = "Smoothed version of calendar time.")))
```
