...
```{r}
PlotMCMCDiagnostic(params$InputData$Artifacts$F$Beta, plotType = "trace")
```

**Figure 2. Autocorrelation plot**<br />
```{r}
PlotMCMCDiagnostic(params$InputData$Artifacts$F$Covariance, plotType = "autocorrelation")
```
...
```{r}
PlotMCMCDiagnostic(params$InputData$Artifacts$M$Beta, plotType = "trace")
```

**Figure 4. Autocorrelation plot**<br />
```{r}
PlotMCMCDiagnostic(params$InputData$Artifacts$M$Covariance, plotType = "autocorrelation")
```
