...
knitr::opts_chunk$set(echo = FALSE, results = "markup", message = FALSE, warning = FALSE, include = TRUE)
...
```{r, results = "asis", eval = {!is.null(params$InputData$Artifacts$OutputPlotStrat)}}
